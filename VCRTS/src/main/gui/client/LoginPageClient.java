...
public class LoginPageClient extends JPanel {
    private static final Logger logger = Logger.getLogger(LoginPageClient.class.getName());
    ...
    public LoginPageClient(ClientFrame parent) {
        this.parent = parent;
        setOpaque(true);
